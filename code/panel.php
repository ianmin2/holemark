			...
			<div class="top-navbar">
				<div class="top-navbar-inner">
					...
					<div class="logo-brand">
						<a href="index.html"><img src="assets/img/sentir-logo-primary.png" alt="Holemark Exam Management"></a>
					</div><!-- /.logo-brand -->
					<!-- End Logo brand -->
						...
						<div class=" collapse navbar-collapse" id="main-fixed-nav">
							...
							<form class="navbar-form navbar-left" role="search">
								<div class="form-group">
									<code style="font-family:Courier New, Courier, monospace; font-size: 25px; color: green;text-shadow: 1px 1px blue;  ">Holemark Exam Management</code>
