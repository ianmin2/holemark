...
<div style="font-family: courier; display: block; " class="  alert alert-success center-block alert-bold-border fade in alert-dismissable col-lg-12 "  id="newStudent"  >
