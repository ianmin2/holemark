                        ...
                        <table class="twelve columns">
                          <tr>
                            ...
                            <td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
                              <span class="template-label">HOLEMARK| Exam Management</span>
                            </td>
                        ...
                        <tr>
                          <td>
                            <h1><code>Hi, $this->to_name</code></h1>
										<p>Thank you for using the holemark exam managent service!</p>
										<br />
                						<p class="lead">Subject: <code>$this->subject</code></p>
                						<p></p>
                						<p></p>                						
                						$this->content
                          </td>
                      ...
                      <table class="six columns">
                        <tr>
                          <td class="last right-text-pad">
                            <h5>Contact Info:</h5>
                            <p>Phone: +254 7** ******</p>
                            <p>Email: holemark@holemark.co.ke </p>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td align="center">
                            ...
                            <a href="http://www.holemark.co.ke"> Holemark.co.ke </a>
